...
namespace Prism.API.Defs
{
    ...
    public enum NpcAiStyle
    {
        ...
        /// </summary>
        NebulaFloater = 97,
        /// <summary>Unused, does nothing.</summary>
        _Unused98 = 98,
        /// <summary>Affected by gravity, is destroyed by tiles or the player.</summary>
        SolarFragment = 99,
        /// <summary>Follows a wavy pattern, blocked by tiles.</summary>
        AncientLight = 100,
        /// <summary>Stays stationary and degrades into four projectiles after a bit.</summary>
        AncientDoom = 101,
        /// <summary>Hovers and moves slowly while spawning particles, occasionally spawning sandnados.</summary>
        SandElemental = 102,
        /// <summary>Moves through blocks and regularly charges a player.</summary>
        SandShark = 103,
        /// <summary></summary>
        DD2AttackerTest = 104,
        /// <summary>Remains stationary, but ends the Old One's Army event when dead.</summary>
        EterniaCrystal = 105,
        /// <summary>Spawns the Old One's Army enemies.</summary>
        MysteriousPortal = 106,
        /// <summary>An improved version of Fighter that targets the Eternia Crystal</summary>
        DD2Fighter = 107,
        /// <summary>Flies and dives to the player.</summary>
        DD2Wyvern = 108,
        DarkMage = 109,
        Besty = 110,
